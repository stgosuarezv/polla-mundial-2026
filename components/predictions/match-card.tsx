            ...
            className={cn(
              ...
              saveStatus === "saved"
                ...
                : saveStatus === "error"
                  ...
                  : "bg-primary/10 text-primary hover:bg-primary/20 disabled:opacity-40 dark:border dark:border-white/30 dark:bg-white/10 dark:text-white dark:hover:bg-white/15"
            )}
          >
            {saveStatus === "saving"
              ? t.saving
